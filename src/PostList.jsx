...
import selectRoles from "./utils/Roles.json";
import selectCompany from "./utils/ComapnyName.json";
import selectExperience from "./utils/Experience.json";
import selectMaxSalary from "./utils/BasePay.json";
